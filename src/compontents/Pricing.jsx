      ...
      >
        {pricingplan.map((item, index) => (
          ...
          >
            ...
            <h1 className="text-limegreen font-bold text-[55px] font-ubutu">
              {item.price}
              <span className="text-limegreen text-lg pl-2 font-ubuntu">
                Monthly
              </span>
            </h1>
            <button className="w-full bg-limegreen font-semibold rounded-xl x-6 py-3 text-lg hover:bg-white hover:text-black font-ubuntu">
              {item.label}
            </button>
            <p className="text-wgite text-lg font-semibold font-ubuntu">
              {item.specs}
            </p>
